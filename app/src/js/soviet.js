...
function setTrackInfo(track) {
    ...
    if (typeof track === 'string') {
        ...
        navigator.mediaSession.metadata = new MediaMetadata({
              title: trackStruct['title'],
              artist: trackStruct['artist'],
              album: 'Радио «Советская Волна»',
              artwork: [
                      { src: '/assets/sprites/favicons/artwork96.png',   sizes: '96x96',   type: 'image/png' },
                      { src: 'https://dummyimage.com/artwork128.png', sizes: '128x128', type: 'image/png' },
                      { src: '/assets/sprites/favicons/artwork192.png', sizes: '192x192', type: 'image/png' },
                      { src: 'https://dummyimage.com/artwork256.png', sizes: '256x256', type: 'image/png' },
                      { src: 'https://dummyimage.com/artwork384.png', sizes: '384x384', type: 'image/png' },
                      { src: '/assets/sprites/favicons/artwork512.png', sizes: '512x512', type: 'image/png' },
                    ]
            });
